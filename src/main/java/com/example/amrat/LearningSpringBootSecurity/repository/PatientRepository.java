...
import com.example.amrat.LearningSpringBootSecurity.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.example.amrat.LearningSpringBootSecurity.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
